...
100-status_code.sh: Bash script that sends a GET request to a given URL without using pipes, redirection, ;, or && and displays the status code of the response.
8. cURL a JSON file
